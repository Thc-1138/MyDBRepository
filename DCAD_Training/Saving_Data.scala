...
.option("path","/dbfs/tmp/output/customerPurchases")
.save
...
// MAGIC %fs ls /dbfs/tmp/output/customerPurchases
...
// MAGIC %fs ls /dbfs/tmp/output/customerPurchases/item_category=Books/
...
spark.read.parquet("dbfs:/dbfs/tmp/output/customerPurchases/item_category=Books")
